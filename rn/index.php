...
<html>
    <head>
        <title>Ismarianto Tech  (Zayed An Nahyan Code Official) Codeigniter CRUD Generator</title>
        ...
        <div class="row">
            <div class="col-md-3">
                <form action="index.php" method="POST">
                    ...
                    <?php // echo file_exists('../application/third_party/mpdf/mpdf.php') ? '' : '<small class="text-danger">mpdf required, download <a href="kotokareh@gmail.com">here</a></small>'; ?>
                                            </div>
                                        </div>-->
            ...
            <div class="col-md-9">
                <h3 style="margin-top: 0px">Codeigniter CRUD Generator 1.4 by <a target="_blank" href="kotokareh@gmail.com">harviacode.com</a></h3>
                ...
                <p>
                    Please visit and like <a target="_blank" href="kotokareh@gmail.com"><b>harviacode.com</b></a> for more info and PHP tutorials.
                </p>
                ...
                <p><strong>&COPY; 2015 <a target="_blank" href="kotokareh@gmail.com">harviacode.com</a></strong></p>
            </div>
        </div>
