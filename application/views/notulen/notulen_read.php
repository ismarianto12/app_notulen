...
<table>
	<tbody> 
		<tr>
			<td width="190" rowspan="3" valign="top"><p style="padding: 32px"><img src="<?= base_url('assets/img/'.$logo['logo']) ?>" class="img-responsive" id="image_upload_preview" style="width: 100px" onerror="this.src='<?= base_url('assets/img/no_image.jpg') ?>';"></p></td>
  ...
  <br />
  <a href="<?= base_url('notulen/excel_not_detail/'.$data['id_notulen'].'/word') ?>" class="btn btn-primary" target="_blank">Download Ms Word</a>

  * ) <span>Untuk export word silahlan ganti layout mode di menu layout word menjaid book layout pada ukuran A4 kertas cetak.</span>
  <hr />
    <a href="<?= base_url('notulen/excel_not_detail/'.$data['id_notulen'].'/print') ?>" class="btn btn-primary" target="_blank">Print</a>
</div>
</div>
</div>
</div>